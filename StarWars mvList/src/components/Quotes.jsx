...
/* 
    Peguei A maior parte deste codigo deste site https://codepen.io/dhuddleston/pen/yegXEJ
    Daniel Huddleston sendo criador original deste codigo.
    so modifiquei para que no carregamento da pagina uma nova fala aleatoria seja mostrada
*/
  ...
  return (
    <div>
      {carregar ? (
        ...
        <h1 className='Quotes'>Carregando...</h1>
      )}
    </div>
  )
}
